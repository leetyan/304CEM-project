...
module.exports = {
    ...
    item: function (req, callback) {
        sql = mysql.format('SELECT * FROM user WHERE username = ?', [req.params.id]);
        return connection.query(sql, callback);
    },
    ...
    delete: function (req, callback) {
        sql = mysql.format('DELETE FROM user WHERE username = ?', [req.params.id]);
        return connection.query(sql, callback);
    },
    ...
    patch: function (req, callback) {       
        sql = mysql.format('UPDATE user SET ? WHERE username = ?', [req.body, req.params.id]);
        return connection.query(sql, callback);
    }
};